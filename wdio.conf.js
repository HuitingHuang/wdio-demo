...
export const config = {
    ...
    //
    maxInstances: process.env.PARALLEL_NUMBER && process.env.PARALLEL_NUMBER.length > 0 ? Number(process.env.PARALLEL_NUMBER) : 2,
    //
    ...
    mochaOpts: {
        ui: 'bdd',
        timeout: 60000,
        grep: process.env.TAGS && process.env.TAGS.length > 0 ? process.env.TAGS : undefined
    },
